...
var toInsertedAt = require( './../lib/assign.js' );
...
tape( 'the function throws an error if provided a second argument which is out-of-bounds (generic)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			toInsertedAt( x, value, 0, out, 1, 0 );
		};
	}
});
...
tape( 'the function throws an error if provided a second argument which is out-of-bounds (float64)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			toInsertedAt( x, value, 0.0, out, 1, 0 );
		};
	}
});
...
tape( 'the function throws an error if provided a second argument which is out-of-bounds (complex128)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			toInsertedAt( x, value, new Complex128( 0.0, 0.0 ), out, 1, 0 );
		};
	}
});
...
tape( 'the function copies elements to another array and inserts a provided value at a specified index (generic)', function test( t ) {
	var expected;
	var actual;
	var out;
	var x;
	...
	out = zeros( x.length+1, 'generic' );
	expected = [ 5, 1, 2, 3 ];
	actual = toInsertedAt( x, 0, 5, out, 1, 0 );
	...
	actual = toInsertedAt( x, 1, 5, out, 2, 0 );
	...
	actual = toInsertedAt( x, 2, 5, out, -2, out.length-1 );
...
tape( 'the function copies elements to another array and inserts a provided value at a specified index (float64)', function test( t ) {
	var expected;
	var actual;
	var out;
	var x;
	...
	actual = toInsertedAt( x, 0, 5.0, out, 1, 0 );
	...
	actual = toInsertedAt( x, 1, 5.0, out, 2, 0 );
	...
	actual = toInsertedAt( x, 2, 5.0, out, -2, out.length-1 );
...
tape( 'the function copies elements to another array and inserts a provided value at a specified index (int32)', function test( t ) {
	var expected;
	var actual;
	var out;
	var x;
...
tape( 'the function copies elements to another array and inserts a provided value at a specified index (complex128)', function test( t ) {
	var expected;
	var actual;
	var out;
	var x;
	...
	actual = toInsertedAt( x, 0, new Complex128( 7.0, 8.0 ), out, 1, 0 );

	t.strictEqual( actual, out, 'returns expected value' );
	t.strictEqual( isSameComplex128Array( actual, expected ), true, 'returns expected value' );

	out = zeros( ( x.length+1 )*2, 'complex128' );
	expected = new Complex128Array( [ 1.0, 2.0, 0.0, 0.0, 7.0, 8.0, 0.0, 0.0, 3.0, 4.0, 0.0, 0.0, 5.0, 6.0, 0.0, 0.0 ] );
	actual = toInsertedAt( x, 1, new Complex128( 7.0, 8.0 ), out, 2, 0 );

	t.strictEqual( actual, out, 'returns expected value' );
	t.strictEqual( isSameComplex128Array( actual, expected ), true, 'returns expected value' );

	out = zeros( ( x.length+1 )*2, 'complex128' );
	expected = new Complex128Array( [ 0.0, 0.0, 5.0, 6.0, 0.0, 0.0, 7.0, 8.0, 0.0, 0.0, 3.0, 4.0, 0.0, 0.0, 1.0, 2.0 ] );
	actual = toInsertedAt( x, 2, new Complex128( 7.0, 8.0 ), out, -2, out.length-1 );
...
tape( 'the function copies elements to another array and inserts a provided value at a specified index (bool)', function test( t ) {
	var expected;
	var actual;
	var out;
	var x;
	...
	actual = toInsertedAt( x, 0, true, out, 1, 0 );
	...
	actual = toInsertedAt( x, 1, true, out, 2, 0 );
	...
	actual = toInsertedAt( x, 2, false, out, -2, out.length-1 );
...
tape( 'the function copies elements to another array and inserts a provided value at a specified index (accessors)', function test( t ) {
	var expected;
	var actual;
	var out;
	var x;
...
tape( 'the function copies elements to another array and inserts a provided value at a specified index (array-like)', function test( t ) {
	var expected;
	var actual;
	var out;
	var x;
