...
tape( 'the function throws an error if provided a second argument which is out-of-bounds (complex128)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			toInsertedAt( x, value, new Complex128( 0.0, 0.0 ) );
		};
	}
});
...
tape( 'the function returns a new array containing all elements from an input array and with a provided value inserted at a specified index (generic)', function test( t ) {
	var expected;
	var actual;
	var x;
...
tape( 'the function returns a new array containing all elements from an input array and with a provided value inserted at a specified index (float64)', function test( t ) {
	var expected;
	var actual;
	var x;
...
tape( 'the function returns a new array containing all elements from an input array and with a provided value inserted at a specified index (int32)', function test( t ) {
	var expected;
	var actual;
	var x;
	...
	expected = new Int32Array( [ 1, 2, 3, 5 ] );
	actual = toInsertedAt( x, 3, 5 );
...
tape( 'the function returns a new array containing all elements from an input array and with a provided value inserted at a specified index (complex128)', function test( t ) {
	var expected;
	var actual;
	var x;
	...
	actual = toInsertedAt( x, 0, new Complex128( 7.0, 8.0 ) );
	...
	actual = toInsertedAt( x, 1, new Complex128( 7.0, 8.0 ) );
	...
	actual = toInsertedAt( x, 2, new Complex128( 7.0, 8.0 ) );
	...
	actual = toInsertedAt( x, 3, new Complex128( 7.0, 8.0 ) );
...
tape( 'the function returns a new array containing all elements from an input array and with a provided value inserted at a specified index (accessors)', function test( t ) {
	var expected;
	var actual;
	var x;
...
tape( 'the function returns a new array containing all elements from an input array and with a provided value inserted at a specified index (array-like)', function test( t ) {
	var expected;
	var actual;
	var x;
